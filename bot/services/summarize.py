...
SUMMARY_STYLES = {
    "detailed": SummaryStyle(
        key="detailed",
        title="Более развернуто",
        prompt_suffix=(
            "Сделай развернутый, но собранный конспект.\n"
            "Структура ответа:\n"
            "1. Блок 'Самое главное' и 1-2 предложения с центральной идеей.\n"
            "2. Блок 'Кратко' и 2-3 предложения о чем материал.\n"
            "3. Блок 'Уточнения' и 5-9 маркированных пунктов.\n"
            "4. Блок 'Вывод' и 2-3 предложения с итогом."
        ),
    ),
    "short": SummaryStyle(
        key="short",
        ...
        prompt_suffix=(
            ...
            "Структура ответа:\n"
            "1. Блок 'Самое главное' и 1 короткое предложение.\n"
            "2. Блок 'Кратко' и 1-2 предложения.\n"
            "3. Блок 'Уточнения' и 3-5 пунктов.\n"
    ...
    "post": SummaryStyle(
        ...
        prompt_suffix=(
            ...
            "Структура ответа:\n"
            "1. Блок 'Самое главное' и 1-2 цепляющих предложения.\n"
            "2. Блок 'Кратко' и 2-3 предложения.\n"
            "3. Блок 'Уточнения' и 4-7 ярких пунктов.\n"
            "4. Блок 'Вывод' и короткий призыв."
        ),
    ),
}
...
BASE_PROMPT = (
    ...
    "Не используй markdown-заголовки со знаками #. "
    "Используй только обычный текст и маркированные пункты.\n\n"
)
